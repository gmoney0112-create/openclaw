...
function createPluginRecord(params: {
  ...
  return {
    ...
    skillProviderIds: [],
    researchProviderIds: [],
    osAutomationProviderIds: [],
    voiceInterfaceProviderIds: [],
    autoCoderProviderIds: [],
    dealSourcingProviderIds: [],
    leadGenerationProviderIds: [],
    salesAutomationProviderIds: [],
    growthHackingProviderIds: [],
    saasBuilderProviderIds: [],
    revenueOptimizationProviderIds: [],
    contentFactoryProviderIds: [],
    projectManagerProviderIds: [],
    decisionEngineProviderIds: [],
    businessLoopProviderIds: [],
    gatewayMethods: [],
    cliCommands: [],
    services: [],
    commands: [],
